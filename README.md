...
-   [Getting Started](#gettingstarted)
  ...
  *   [Upgrading Versions](#upgradingVersions)
...
### <a name="upgradingVersions"></a> Upgrading Versions

To upgrade the PerimeterX Enfocer: 
...
As of version 4.0, Captcha logic is being handled though the JavaScript snippet and not thought the Enforcer.
