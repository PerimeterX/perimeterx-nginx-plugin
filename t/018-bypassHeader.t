...
Process a bad cookie in monitor mode with bypass header
...
--- config
    location = /t {
	    ...
	    set_by_lua_block $config {
    	    ...
    	    pxconfig.bypass_monitor_header = "x-px-block"
            return true
        }
...
=== TEST 2: Procoss Workflow
Process a bad cookie in monitor mode without bypass header
